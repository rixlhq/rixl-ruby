            ...
            module Subtitles
                module Language
                    ...
                    class LanguageRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## 
                        ## Gets an item from the RixlSdk.videos.item.subtitles.language.item collection
                        ...
                        def by_lang_code(lang_code)
                            ...
                            return RixlSdk::Videos::Item::Subtitles::Language::Item::WithLangCodeItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
